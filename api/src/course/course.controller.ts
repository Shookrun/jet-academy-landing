  ...
  @ApiBody({
    ...
    schema: {
      ...
      properties: {
        ...
        'description[en]': { type: 'string', example: 'Full Stack Web Development Course' },
        'slug[az]': { type: 'string', example: 'full-stack-development' },
        'slug[en]': { type: 'string', example: 'development-full-stack' },
        duration: { type: 'number', example: 12 },
        'level[az]': { type: 'string', example: 'Başlanğıc' },
        'level[en]': { type: 'string', example: 'Elementary' },
        ...
        'newTags[en]': { type: 'array', items: { type: 'string' }, example: ['Scratch', 'HTML'] },
